//
//  PersonEditSizeTypeController.m
//  QuickGifter
//
...
@implementation PersonEditSizeTypeController
...
- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SizeTypeCell"];
    if (cell == nil) {
        cell = [[[UITableViewCell alloc] initWithFrame:CGRectZero reuseIdentifier:@"SizeTypeCell"] autorelease];
    }
